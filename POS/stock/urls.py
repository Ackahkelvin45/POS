...
from . import views
from .views import GetAvailableQuantityView,GetAvailablePackageQuantityView
...
urlpatterns = [
    ...
    path('get_available_quantity/', GetAvailableQuantityView.as_view(), name='get_available_quantity'),
     path('get_available_package_quantity/', GetAvailablePackageQuantityView.as_view(), name='get_available_package_quantity'),
